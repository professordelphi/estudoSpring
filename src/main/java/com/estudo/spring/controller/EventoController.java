...
public class EventoController {
	 ...
	 */
	@RequestMapping(method = RequestMethod.GET, value = "/chamartelacadastroevento", produces = MediaType.APPLICATION_JSON_UTF8_VALUE) // Define
	...
	/*
	 * Executa o cadastro de evento observação: O ModelAndView usado com
	 * o @RestController funcionou mas com o @Controller não funcionou
	 */
	...
	/**
	 * O metodo detalhesEventos, recebe o valor do codigo do evento, localiza
	 * atraves do metodo findByCodigo e atraves do ModelAndView redireciona Para
	 * Atualizar foi usado o metodo save de eventoRepository no metodo form desta
	 * classe
	 * 
	 * 
	 * @param codigo
	...
	/*
	 * 
	 * O metodo abaixo nao retornou o json e sim tela vazia pois o ModelAndView
	 * precisa de um objeto na camada visual para mostrar o conteudo da consulta
	 */
	 ...
	 * public Evento listaEventosAPI(@RequestParam("nome") String
	 * nome,@RequestParam("data") String data) {
	 * 
	 * 
	 * 
	 ...
	 *
	 * @Entity
	 * @Table(name = "PEDIDOS") public class PedidoEntity implements Serializable {
	 * 
	 * @EmbeddedId private PedidoId id;
	 * 
	 * @Column(name = "STATUS") private Integer status;
	 * 
	 * @Column(name = "DATA_ENTREGA") private LocalDateTime dataEntrega;
	 * 
	 * @ManyToOne(fetch = FetchType.EAGER)
	 * @JoinColumns(value = {
	 * @JoinColumn(name = "ID_CLIENTE", referencedColumnName = "ID_CLIENTE" ),
	 * @JoinColumn(name = "EMPRESA", referencedColumnName = "EMPRESA" )}) private
	 ...
	 * 
	 * 
	 *                  Sugestão CRIAR VIEW COM 2 CAMPOS NOME E DATA PARA PESQUISA
	 *                  COMPOSTA
	 */
